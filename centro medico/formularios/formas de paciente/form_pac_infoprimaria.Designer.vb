...
Partial Class form_pac_infoprimaria
    ...
    Private Sub InitializeComponent()
        ...
        Me.tb_IPDescrip = New ctrlTextboxAvanzado
        Me.tb_IPDetalle = New ctrlTextboxAvanzado
