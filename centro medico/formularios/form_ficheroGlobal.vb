Imports System.IO
Public Class form_ficheroGlobal

    Dim fcurrentAcc As Integer
    Dim fId As Integer
    Dim fSeccion As String
    Dim fRefRegistro As Integer
    ...
    Private Sub FICHEROSBindingNavigatorSaveItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.Validate()
        Me.FICHEROSGLOBALBindingSource.EndEdit()
        Me.FICHEROSGLOBALTableAdapter.Update(Me.CMDataSet.FICHEROSGLOBAL)

    End Sub
    Private Sub Inicializa()
        Dim _data As CMDataSet.FICHEROSGLOBALDataTable = Me.FICHEROSGLOBALTableAdapter.GetDataBySeccionReferenciaId(Me.fSeccion, fRefRegistro, Me.fId)
    ...
    End Sub
    Sub New(ByVal aName As String, ByVal aCurrentAccion As Enums.Accion, ByVal aId As String, ByVal aSeccion As String, ByVal aRefRegistro As Integer)
        ...
        Me.Text = aName
        Me.fId = aId
        Me.fSeccion = aSeccion
        Me.fRefRegistro = aRefRegistro
    ...
    Private Sub form_ficheros_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.FICHEROSGLOBALTableAdapter.FillBySeccionReferenciaId(Me.CMDataSet.FICHEROSGLOBAL, Me.fSeccion, Me.fRefRegistro, Me.fId)
        ...
        If clickaccept = False And Not Me.CurrentAccion = Enums.Accion.Ver Then
            ...
            If Me.CurrentAccion = Enums.Accion.Modificar Then
                If MessageBox.Show("Esta seguro que desea modificar los datos ", "Modificar", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) = Windows.Forms.DialogResult.OK Then
                    Me.FICHEROSGLOBALTableAdapter.UpdateQueryById(fId, fRefRegistro, _nombre, _descrip, _fecha, fSeccion, fId)
            ...
            Else
                If MessageBox.Show("Esta seguro que desea insertar los datos ", "Insertar", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) = Windows.Forms.DialogResult.OK Then
                    'EL NUEVO ID DEBE HABERSE PASADO EN EL CONSTRUCTOR.
                    Me.FICHEROSGLOBALTableAdapter.InsertQuery(fId, fRefRegistro, _nombre, _descrip, _fecha, fSeccion)
                ...
                End If
            End If
            Me.FICHEROSGLOBALTableAdapter.FillBySeccionReferencia(CMDataSet.FICHEROSGLOBAL, fSeccion, fRefRegistro)
