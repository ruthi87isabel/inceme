...
Partial Public Class CM2DataSet
    ...
    Partial Public Class PacientesBonosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Default Public ReadOnly Property Item(ByVal index As Integer) As PacientesBonosRow
            Get
    ...
    Partial Public Class PacientesBonosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        PACIENTES.NOMBRE, PACIENTES.APELLIDO1, PACIENTES.APELLIDO2, PACIENT" & _
                "ES.DNI, PACIENTES.FECHAN, COUNT(Bonos.id) AS BONOS, SUM(Bonos.numsesiones) - COU" & _
                "NT(Sesiones.id) AS SESIONES" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM            PACIENTES INNER JOIN" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "             " & _
                "            Bonos ON PACIENTES.CPACIENTE = Bonos.cpaciente LEFT OUTER JOIN" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "    " & _
                "                     Sesiones ON Bonos.id = Sesiones.refbono" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "GROUP BY PACIENTES" & _
                ".NOMBRE, PACIENTES.APELLIDO1, PACIENTES.APELLIDO2, PACIENTES.DNI, PACIENTES.FECH" & _
                "AN"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
