Public Class frmPedidosProveedor_ADD
    ...
    'RE = 4% (+3,48€)
    'IRPF = 15% (-13,05€)
    'Con lo que al final tenemos un Total presupuestoado de 91,35 €


    Public ID_PedidoProveedor As Long = -1
    Public PedidoProveedor As CMDataSet.N_PedidosProveedorRow = Nothing
    'Public Cliente As CMDataSet.N_ClientesRow

    Dim totalesAdapter As CMDataSetTableAdapters.N_PedidosProveedor_TotalesTableAdapter = New CMDataSetTableAdapters.N_PedidosProveedor_TotalesTableAdapter()
    Dim totalesTable As CMDataSet.N_PedidosProveedor_TotalesDataTable = New CMDataSet.N_PedidosProveedor_TotalesDataTable()
    ...
    Private Sub frmPedidosProveedor_ADD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'CMDataSet.N_PedidosProveedor_Lineas' table. You can move, or remove it, as needed.

        Me.N_PedidosProveedor_TiposTableAdapter.Fill(Me.CMDataSet.N_PedidosProveedor_Tipos)
        'Estados

        For Each o As Object In [Enum].GetValues(GetType(Globales.PedidosProveedor_Estado))
        ...
        If ID_PedidoProveedor <> -1 Then
            Me.N_PedidosProveedorTableAdapter.FillBy(Me.CMDataSet.N_PedidosProveedor, ID_PedidoProveedor)
            PedidoProveedor = Me.CMDataSet.N_PedidosProveedor(0)
            If Not PedidoProveedor.IsID_EstadoNull() Then
                cmb_Estado.SelectedItem = CType(PedidoProveedor.ID_Estado, Globales.PedidosProveedor_Estado)
            End If

            'Cargar lineas
            Me.N_PedidosProveedor_LineasTableAdapter.Fill(Me.CMDataSet.N_PedidosProveedor_Lineas, PedidoProveedor.ID_PedidoProveedor)

            'Cargar Tab Totales
            CargaTotales()

            'Documentos Relacionados
            Me.CtrlDocProcesados1.id_Doc = ID_PedidoProveedor
            Me.CtrlDocProcesados1.tipoDoc = Globales.TipoDocumento.PedidoProveedor
            Me.CtrlDocProcesados1.CargaDocumentosRelacionados()
        Else
            'Crearlo Nuevo
            PedidoProveedor = N_PedidosProveedorBindingSource.AddNew().Row()
            CodigoTextBox.Text = Globales.GeneraCodigoAutomatico("N_PedidosProveedor", "ID_PedidoProveedor", "000000")
            N_PedidosProveedor_TiposComboBox.SelectedIndex = 0
            PedidoProveedor.ID_Estado = Globales.PedidosProveedor_Estado.Pendiente_Recibir
            cmb_Estado.SelectedItem = Globales.PedidosProveedor_Estado.Pendiente_Recibir
            PedidoProveedor.Fecha = Date.Now
            PedidoProveedor.Total = 0
            txt_Total.Text = 0
        End If
...
#Region "Private Sub CargaTotales()"
    Private Sub CargaTotales()
        ...
        'Dim totalesAdapter As CMDataSetTableAdapters.N_PedidosProveedor_TotalesTableAdapter = New CMDataSetTableAdapters.N_PedidosProveedor_TotalesTableAdapter()
        'Dim totalesTable As CMDataSet.N_PedidosProveedor_TotalesDataTable = New CMDataSet.N_PedidosProveedor_TotalesDataTable()
        totalesAdapter.Fill(totalesTable, ID_PedidoProveedor)
        ...
        For Each row As DataRow In totalesTable.Select(Nothing, "IVAPorciento DESC")
            ...
            Dim totalRow As CMDataSet.N_PedidosProveedor_TotalesRow = row
...
#Region "Private Sub AnnadeTextBoxSimple(ByRef totalRow As CMDataSet.N_PedidosProveedor_TotalesRow, ByVal count As Integer, ByRef controlGuia As Control, ByVal columnName As String, ByVal txtBoxReadOnly As Boolean)"
    Private Sub AnnadeTextBoxSimple(ByRef totalRow As CMDataSet.N_PedidosProveedor_TotalesRow, ByVal count As Integer, ByRef controlGuia As Control, ByVal columnName As String, ByVal txtBoxReadOnly As Boolean)
...
#Region "Private Sub AnnadeTextBoxDobles(ByRef totalRow As CMDataSet.N_PedidosProveedor_TotalesRow, ByVal count As Integer, ByRef controlGuia As Control, ByVal columnNamePorciento As String, ByVal columnNameCantidad As String)"
    Private Sub AnnadeTextBoxDobles(ByRef totalRow As CMDataSet.N_PedidosProveedor_TotalesRow, ByVal count As Integer, ByRef controlGuia As Control, ByVal columnNamePorciento As String, ByVal columnNameCantidad As String)
...
#Region "Private Sub PorcientosKeyUp(ByVal sender As Object, ByVal e As KeyEventArgs)"
    Private Sub PorcientosKeyUp(ByVal sender As Object, ByVal e As KeyEventArgs)
        ...
        Dim totalRow As CMDataSet.N_PedidosProveedor_TotalesRow = controlCantidad.Tag
...
#Region "Private Sub AnnadeTextBoxDobles_ReadOnly(ByRef totalRow As CMDataSet.N_PedidosProveedor_TotalesRow, ByVal count As Integer, ByRef controlGuia As Control, ByVal columnNamePorciento As String, ByVal columnNameCantidad As String)"
    Private Sub AnnadeTextBoxDobles_ReadOnly(ByRef totalRow As CMDataSet.N_PedidosProveedor_TotalesRow, ByVal count As Integer, ByRef controlGuia As Control, ByVal columnNamePorciento As String, ByVal columnNameCantidad As String)
...
#Region "Private Function Guardar() As Boolean"
    Private Function Guardar() As Boolean
        ...
        If Me.CtrlProveedor1.Proveedor Is Nothing Then
            ...
            Exit Function
        End If
        PedidoProveedor.Total = txt_Total.Text
        Me.Validate()
        Me.N_PedidosProveedorBindingSource.EndEdit()
        Me.N_PedidosProveedorTableAdapter.Update(Me.CMDataSet.N_PedidosProveedor)
        ID_PedidoProveedor = PedidoProveedor.ID_PedidoProveedor

        'Guardar Totales
        GuardaTotales()
        Globales.AuditoriaInfo.Registra(Globales.AuditoriaInfo.Accion.Guardar, RoleManager.Items.Pedidos_Compras, "Pedidos Proveedor", PedidoProveedor.ID_PedidoProveedor.ToString(), "")
...
#Region "Private Sub btn_NuevaLinea_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_NuevaLinea.Click"
    Private Sub btn_NuevaLinea_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_NuevaLinea.Click
        ...
        Dim frm As frmPedidosProveedor_Lineas_ADD = New frmPedidosProveedor_Lineas_ADD()
        frm.ID_PedidoProveedor = ID_PedidoProveedor
...
#Region "Private Sub N_PedidosProveedor_LineasDataGridView_CellFormatting(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles N_PedidosProveedor_LineasDataGridView.CellFormatting"
    Private Sub N_PedidosProveedor_LineasDataGridView_CellFormatting(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles N_PedidosProveedor_LineasDataGridView.CellFormatting
...
#Region "Private Sub N_PedidosProveedor_LineasDataGridView_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles N_PedidosProveedor_LineasDataGridView.SelectionChanged"
    Private Sub N_PedidosProveedor_LineasDataGridView_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles N_PedidosProveedor_LineasDataGridView.SelectionChanged
        btn_Eliminar.Enabled = N_PedidosProveedor_LineasDataGridView.SelectedRows.Count > 0
        btn_Editar.Enabled = N_PedidosProveedor_LineasDataGridView.SelectedRows.Count > 0
    End Sub
#End Region
...
#Region "Private Sub btn_Editar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Editar.Click"
    Private Sub btn_Editar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Editar.Click
        Dim PedidoProveedor_Linea As CMDataSet.N_PedidosProveedor_LineasRow = N_PedidosProveedor_LineasDataGridView.SelectedRows(0).DataBoundItem.Row

        Dim frm As frmPedidosProveedor_Lineas_ADD = New frmPedidosProveedor_Lineas_ADD()
        frm.ID_PedidoProveedor_Linea = PedidoProveedor_Linea.ID_PedidoProveedorLineas
        frm.ID_PedidoProveedor = PedidoProveedor_Linea.ID_PedidoProveedor
        If frm.ShowDialog() = Windows.Forms.DialogResult.OK Then
            Dim pos As Integer = N_PedidosProveedor_LineasDataGridView.SelectedRows(0).Index
            Me.N_PedidosProveedor_LineasTableAdapter.Fill(Me.CMDataSet.N_PedidosProveedor_Lineas, PedidoProveedor.ID_PedidoProveedor)
            CargaTotales()
            N_PedidosProveedor_LineasDataGridView.Rows(pos).Selected = True
        End If
    End Sub
#End Region


    Private Sub N_PedidosProveedor_LineasDataGridView_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles N_PedidosProveedor_LineasDataGridView.CellDoubleClick
        btn_Editar_Click(Nothing, Nothing)
    End Sub

    Private Sub btn_Eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Eliminar.Click
        Dim PedidoProveedor_Linea As CMDataSet.N_PedidosProveedor_LineasRow = N_PedidosProveedor_LineasDataGridView.SelectedRows(0).DataBoundItem.Row
        PedidoProveedor_Linea.Delete()
        N_PedidosProveedor_LineasTableAdapter.Update(CMDataSet.N_PedidosProveedor_Lineas)
        CargaTotales()
    End Sub
