Public Class frmFacturasRecibidas_Lineas_ADD
    ...
    Private Sub btn_Guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Guardar.Click
        ...
        Dim total As CMDataSet.N_FacturasRecibidas_TotalesRow = CMDataSet.N_FacturasRecibidas_Totales.NewN_FacturasRecibidas_TotalesRow()
        total.DescuentoCantidad = 0
        total.DescuentoPorciento = 0
        total.FinanciacionCantidad = 0
        total.FinanciacionPorciento = 0
        total.ID_FacturaRecibida = ID_FacturaRecibida
        ...
        CMDataSet.N_FacturasRecibidas_Totales.AddN_FacturasRecibidas_TotalesRow(total)

        Dim totalAdapter As New CMDataSetTableAdapters.N_FacturasRecibidas_TotalesTableAdapter()
        Try
            totalAdapter.Update(CMDataSet.N_FacturasRecibidas_Totales)
