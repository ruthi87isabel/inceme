Public Class frmFacturasRecibidas_ADD
    ...
    Private Sub frmFacturasRecibidas_ADD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For Each o As Object In [Enum].GetValues(GetType(Globales.FacturasRecibidas_Estado))
        ...
        If ID_FacturaRecibida <> -1 Then
            ...
            If Not FacturaRecibida.IsID_EstadoNull() Then
                cmb_Estado.SelectedItem = CType(FacturaRecibida.ID_Estado, Globales.FacturasRecibidas_Estado)
            End If
            ...
            Me.CtrlDocProcesados1.tipoDoc = Globales.TipoDocumento.FacturaProveedor
            Me.CtrlDocProcesados1.CargaDocumentosRelacionados()
        Else
            'Crearlo Nuevo
            FacturaRecibida = N_FacturasRecibidasBindingSource.AddNew().Row()
            CodigoTextBox.Text = Globales.GeneraCodigoAutomatico("N_FacturasRecibidas", "ID_FacturaRecibida", "000000")
...
#Region "Private Function Guardar() As Boolean"
    Private Function Guardar() As Boolean
        ...
        'Guardar Totales
        GuardaTotales()
        Globales.AuditoriaInfo.Registra(Globales.AuditoriaInfo.Accion.Guardar, RoleManager.Items.Facturas_Compras, "Facturas Compras", FacturaRecibida.ID_FacturaRecibida.ToString(), "")
...
#Region "Private Sub btn_NuevaLinea_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_NuevaLinea.Click"
    Private Sub btn_NuevaLinea_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_NuevaLinea.Click
        ...
        Dim frm As frmFacturasRecibidas_Lineas_ADD = New frmFacturasRecibidas_Lineas_ADD()
...
#End Region
    ...
    Private Sub btn_ValidarLineas_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_ValidarLineas.Click
        ...
        frm.TipoDocDestino = Globales.TipoDocumento.FacturaProveedor
