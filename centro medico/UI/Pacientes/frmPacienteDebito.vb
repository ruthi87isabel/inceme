...
#End Region
    ...
    Private Sub btn_ADD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_ADD.Click
        ...
        frm.Credito = Credito
        frm.Text = "Nuevo pago del Paciente"
        frm.grpAbonar.Enabled = True
        If Debe - Credito > 0 Then
            frm.txtImporteOriginal.Value = Debe - Credito
            frm.txtMontoAbonar.Value = Debe - Credito
        Else
            frm.txtImporteOriginal.Value = 0
            frm.txtMontoAbonar.Value = 0
        End If


        frm.Text = "Introduzca el importe abonado por el paciente"
        frm.lblTextoTotalAPagar.Text = "Débito actual:"
        frm.txtNotas.Text = "Crédito agregado"
    ...
    Private Sub Calcula()
        ...
        Credito = Globales.DameCreditoPaciente(CtrlPaciente1.ID_PACIENTE)
    ...
    Private Sub btnPagar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPagar.Click
        ...
        frm.Credito = Credito
        frm.txtDescripcion.Text = "Importe a ser abonado por el paciente para cubrir los documentos seleccionados."
        ...
        For Each row As GridEXRow In GridEXDocs.GetCheckedRows()
            If row.RowType = RowType.Record Then
                If row.Table.Key = "CITAs" Then
                    ...
                    'If Not Globales.VerificaSiCitaEstaEnUsoYSePuedeProceder(cita.IDCITA) Then
                    '    MessageBox.Show("Esta cita " & entrada.Descripcion & " está en uso y no puede ser pagada")
                    'End If
                    ...
                    Calcula()
                    'If IdCitaParaPagoDirecto.HasValue Then
                    '    If Not RowToPagarDirecto.DataRow Is Nothing Then
