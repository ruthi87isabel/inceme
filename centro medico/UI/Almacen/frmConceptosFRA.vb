Public Class frmConceptosFRA
    ...
    Public Modo As Globals.ModoParaFormas = Globals.ModoParaFormas.Seleccion
    ...
    Private Sub frmConceptosFRA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'permiso de lectura
        If RoleManager.PermisoPorItem(Globals.Usuario.ID_Usuario, RoleManager.Items.Conceptos_Facturables) = RoleManager.TipoPermisos.Lectura Then
            Me.tst_Eliminar.Enabled = False
            Me.NewToolStripButton.Enabled = False
        End If
        If RoleManager.PermisoPorItem(Globals.Usuario.ID_Usuario, RoleManager.Items.Conceptos_Facturables) = RoleManager.TipoPermisos.Modificar Then
            Me.tst_Eliminar.Enabled = False
        End If
        If RoleManager.PermisoPorItem(Globals.Usuario.ID_Usuario, RoleManager.Items.Conceptos_Facturables) = RoleManager.TipoPermisos.Ninguno Then
            Me.ToolStrip1.Enabled = False
        End If
        If RoleManager.PermisoPorItem(Globals.Usuario.ID_Usuario, RoleManager.Items.Conceptos_Facturables) = RoleManager.TipoPermisos.Total Then
